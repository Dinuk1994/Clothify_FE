            ...
            <div className='flex justify-end w-1/3'>
                <div className='flex flex-col items-center'>
                    <div className='flex justify-center mt-4 w-1/2'>
                        ...
                        <label htmlFor="" className='px-2 mt-2 mr-2 tablet-or-mobile:text-xs text-white'>Username</label>
                    </div>
                    <div className='flex justify-center  w-1/2'>
                        <button className='px-2 text-white tablet-or-mobile:text-xs font-bold mb-1'>Login</button>
                        <button className='px-2 text-white tablet-or-mobile:text-xs font-bold mb-1 mr-5'>Register</button>
                    </div>
                </div>
            </div>
